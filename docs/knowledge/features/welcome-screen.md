...
- Ticket notes: `../codebase/7.md` (scaffold), `../codebase/14.md` (`onSetup` external-browser wiring), `../codebase/57.md` (Figma polish), `../codebase/149.md` (pill CTA + 168.dp hero top padding refinement), `../codebase/150.md` (logo arm geometry repair under the old `9:2` source), `../codebase/167.md` (full drawable rewrite to single filled path under the new `80:2` source + Icon bounding-box switch to 92×104dp)
